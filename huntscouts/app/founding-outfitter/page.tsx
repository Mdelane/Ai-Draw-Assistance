    ...
    <>
      ...
      <main>
        ...
        <section className="bg-[#1B4332] text-white py-20 px-6 text-center">
          ...
          <h1 className="text-5xl font-black tracking-tight mb-4">Become a Founding Outfitter</h1>
          ...
          <Link
            ...
            className="bg-amber-400 text-black px-8 py-4 rounded-xl font-black text-lg hover:bg-amber-300 transition-colors"
          >
        ...
        <section className="max-w-3xl mx-auto px-6 py-20">
          <p className="text-xs font-bold uppercase tracking-widest text-[#1B4332] text-center mb-3">What you get</p>
          <h2 className="text-2xl font-black text-gray-900 text-center mb-12">What founding outfitters get</h2>
          <div className="space-y-4">
            {PERKS.map(p => (
              <div key={p.title} className="flex gap-5 bg-white border border-gray-200 rounded-2xl p-6">
                <div className="text-amber-500 font-black text-xl mt-0.5">✓</div>
                <div>
        ...
        <section className="bg-stone-50 py-16 px-6">
          <div className="max-w-2xl mx-auto">
            <h2 className="text-2xl font-black text-gray-900 text-center mb-10">The math</h2>
            <div className="grid grid-cols-2 gap-6">
              <div className="bg-white border border-gray-200 rounded-2xl p-6 text-center">
                <div className="text-gray-400 text-sm uppercase tracking-widest font-bold mb-2">Standard outfitter</div>
              ...
              <div className="bg-[#1B4332] text-white rounded-2xl p-6 text-center">
                <div className="text-green-300 text-sm uppercase tracking-widest font-bold mb-2">Founding outfitter</div>
        ...
        <section className="max-w-2xl mx-auto px-6 py-16">
          <h2 className="text-2xl font-black text-gray-900 mb-8 text-center">Questions</h2>
          <div className="space-y-5">
            {[
              ...
              <div key={q as string} className="border border-stone-200 rounded-2xl p-5">
                <div className="font-black text-gray-900 mb-2">{q as string}</div>
        ...
        <section className="bg-[#1B4332] text-white py-16 px-6 text-center">
          <h2 className="text-2xl font-black mb-3">Ready to list your first hunt?</h2>
          <p className="text-green-200 mb-6">Takes about 10 minutes to set up your profile and first listing.</p>
          <Link
            href="/signup?role=outfitter&founding=1"
            className="bg-amber-400 text-black px-8 py-4 rounded-xl font-black hover:bg-amber-300 transition-colors"
          >
            Get started →
          </Link>
        </section>
