  ...
  return (
    <>
      ...
      <main className="max-w-lg mx-auto px-6 py-10">
        ...
        <h1 className="text-2xl font-black tracking-tight text-gray-900 mb-8">Manage subscription</h1>

        <div className="bg-white border border-gray-200 rounded-2xl p-8 text-center">
          <div className="text-4xl mb-4">🎯</div>
          <h2 className="text-xl font-black tracking-tight text-gray-900 mb-2">Scout Pro</h2>
          ...
          <button
            onClick={openPortal}
            disabled={loading}
            className="w-full bg-amber-400 text-black py-3 rounded-xl font-black hover:bg-amber-300 disabled:opacity-50 transition-colors"
          >
