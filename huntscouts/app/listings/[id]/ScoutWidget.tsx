  ...
  if (drawOdds.length === 0) {
    return (
      <div className="bg-gray-50 border border-gray-200 rounded-2xl p-5">
        <p className="font-semibold text-gray-700 mb-1">Draw odds</p>
  ...
  return (
    <div className="bg-white border border-gray-200 rounded-2xl p-5">
      <div className="flex items-center justify-between mb-4">
        <h3 className="font-semibold text-gray-900">Draw odds</h3>
      ...
      {relevantOdds && (
        <div className="grid grid-cols-3 gap-3 mb-4">
          {[
            ...
            <div key={label as string} className="text-center bg-gray-50 rounded-xl p-3">
              <div className="text-xl font-bold text-[#1B4332]">{val}</div>
